...
export function planCopyOrder(act, cfg, ourShares = 0) {
  ...
  if (side === "BUY") {
    // Tamanho desejado em USDC conforme o modo:
    //  - mirror: o MESMO valor que o alvo gastou (cópia fiel 1:1)
    //  - fixed:  valor fixo por ordem
    //  - proportional: fração do valor do alvo
    let spend =
      cfg.sizeMode === "mirror"
        ? sourceUsd
        : cfg.sizeMode === "fixed"
